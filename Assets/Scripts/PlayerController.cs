...
public class PlayerController : MonoBehaviour
{
    ...
    private int direction = -1; // 1 = up; 2 = down; 3 = right; 4 = left
    ...
    void ReadInputAndMove()
    {
        ...
        // get the next direction from buttons
        ...
        /*if (CrossPlatformInputManager.GetAxis("Horizontal") > 0.65) _nextDir = Vector2.right;
        else if (CrossPlatformInputManager.GetAxis("Horizontal") < -0.65) _nextDir = -Vector2.right;
        else if (CrossPlatformInputManager.GetAxis("Vertical") > 0.65) _nextDir = Vector2.up;
        else if (CrossPlatformInputManager.GetAxis("Vertical") < -0.65) _nextDir = -Vector2.up;*/

        Debug.Log(CrossPlatformInputManager.GetAxisRaw("Horizontal") + ", " + CrossPlatformInputManager.GetAxisRaw("Vertical"));
